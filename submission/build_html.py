...
<pre>TF15 Parquet (S3, ~4 GB/match)
  ...
  <p style="margin-top:10px;"><strong>Scale:</strong> 5 matches &times; ~40 players &times; 2 halves = <strong>400 rows</strong> &middot; 252 unit tests &middot; SageMaker Processing for parallel compute (~15 min)</p>
</div>
