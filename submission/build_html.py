...
<pre>TF15 Parquet (S3, ~4 GB/match)
  ...
  <p style="margin-top:10px;"><strong>Scale:</strong> 5 matches &times; ~40 players &times; 2 halves = <strong>400 rows</strong> &middot; 177 unit tests &middot; SageMaker Processing for parallel compute (~15 min)</p>
</div>
...
body { font-family: 'Segoe UI', Arial, sans-serif; font-size: 10.5pt; color: #e8e8e8;
       background: #1a1a1a; max-width: 860px; margin: 40px auto; padding: 0 40px; line-height: 1.6; }
h1 { font-size: 22pt; color: #e30613; border-bottom: 3px solid #e30613; padding-bottom: 10px; margin-bottom: 6px; }
h2 { font-size: 14pt; color: #e30613; margin-top: 32px; border-bottom: 1px solid #3a1a1a; padding-bottom: 6px; }
h3 { font-size: 11pt; font-weight: 700; margin-top: 20px; color: #ffffff; }
p { margin: 8px 0; }
...
td { border: 1px solid #333; padding: 6px 11px; color: #e8e8e8; }
tr:nth-child(even) td { background: #242424; }
blockquote { border-left: 4px solid #e30613; margin: 14px 0; padding: 8px 16px;
             color: #cccccc; font-style: italic; background: #252525; border-radius: 0 4px 4px 0; }
code { background: #2a2a2a; color: #f0a0a6; padding: 2px 5px; font-size: 9pt; font-family: Consolas, monospace; border-radius: 2px; }
hr { border: none; border-top: 2px solid #e30613; margin: 28px 0; opacity: 0.4; }
a { color: #e30613; }
strong { color: #ffffff; }
.fig { text-align: center; margin: 20px 0; }
.fig img { max-width: 80%; border: 1px solid #333; border-radius: 4px; }
.fig-caption { font-size: 8.5pt; color: #888; margin-top: 5px; }
@media print {
  body { -webkit-print-color-adjust: exact; print-color-adjust: exact; margin: 20px; background: #1a1a1a; }
}
"""
